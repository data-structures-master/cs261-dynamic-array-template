...
class TestDynamicArray(unittest.TestCase):
    ...
    #     start_time = time.perf_counter() # Ignore this line, it's just some instrumentation.
    #     self.assertEqual(999999, a.linear_search(1000004))
    #     print(f"\nLinear Search Time: {time.perf_counter()-start_time}\n")
    ...
    #     print(f"\nBinary Search Time: {time.perf_counter()-start_time}\n")
